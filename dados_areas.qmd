...
::: {.callout-note title="📌" style="background-color:#f3f6fb; border-left: 6px solid #3b82f6;"}
...
![](imagens_espacial/mapas.png){fig-alt="Mapa ilustrando diferentes tipos de dados espaciais: dados de áreas, dados pontuais e dados geoestatísticos." width="900" height="500" fig-align="center"}
...
Figura @fig-contiguity_matr. Critérios de contiguidade espacial. 
- **(Borda comum)** contiguidade por borda comum (rook); 
- **(Vertice comum)** contiguidade por vértice comum (bishop); 
- **(Raio)** contiguidade baseada em raio de distância; 
- **(Segunda ordem)**	contiguidade de primeira, segunda ordem e vizinhos do vizinhos que considera os vizinhos dos vizinhos, vizinhos dos vizinhos dos vizinhos e sucessivamente.

Onde:
b = vizinhos de 1ª ordem (borda comum)
c = vizinhos de 2ª ordem diagonal
d = vizinhos a duas células de distância
